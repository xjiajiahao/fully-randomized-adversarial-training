...
class naive_problem:
    def __init__(self, n_samples_train, n_samples_test, n_classifiers_candidates, n_classifiers, epsilon,
                 nb_iter=10000, lr_position=2., lr_weight=1., noise_level=0.01, n_iters_attack=20, lr_attack=0.1, seed=12):
        self.seed = seed
...
if __name__ == "__main__":
    for seed in range(0, 6):
        ...
        output_file = './data/results_sat_seed_{:02d}.csv'.format(seed)
